...
import { useCreateMeeting } from '@/modules/meetings';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const meetingData = {
        ...
        assigned_to: 1, // Default assigned to user ID 1, should be dynamic
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Schedule a new meeting with clients or leads</p>
              </div>
              <Button
                variant="outline"
                onClick={() => router.back()}
