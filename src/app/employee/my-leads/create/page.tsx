...
import { useCreateLead, useLeadCities, useLeadStatuses, useLeadPriorities, useLeadEmployees, useLeadClients } from '@/modules/employee-leads';
import { CreateEmployeeLeadRequest } from '@/modules/employee-leads/types';
...
export default function CreateLeadPage() {
  ...
  const [formData, setFormData] = useState<CreateEmployeeLeadRequest>({
    name: '',
    email: '',
    phone: '',
    mobile: '',
  ...
  const handleInputChange = (field: keyof CreateEmployeeLeadRequest, value: any) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Object.keys(formData).forEach(key => {
        const value = formData[key as keyof CreateEmployeeLeadRequest];
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4 rtl:space-x-reverse">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">Add a new lead to the system</p>
            </div>
          </div>
        </div>
